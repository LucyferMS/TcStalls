...
public class ConfigUtils {
    ...
    public static YamlConfiguration load(String configName){
        Plugin plugin = TcStalls.getInstance();
    ...
    public static void save(YamlConfiguration c, String file) {
        try {
            c.save(new File(TcStalls.getInstance().getDataFolder(), file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void save(YamlConfiguration c, String folder, String file){
        try {
            c.save(new File(TcStalls.getInstance().getDataFolder() + File.separator + folder, file));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
